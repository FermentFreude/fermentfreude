...
export const workshopOverviewFields: Field[] = [
  ...
  },
  {
    ...
    admin: {
      initCollapsed: true,
      description:
        'Labels for the filterable list below the cards. ⚠️ Only the LABELS (heading, column titles, button text) are edited here. The actual workshop dates, times and spots are managed in **Workshops → Workshop Appointments** (sidebar). Each appointment automatically appears in this list.',
    },
    fields: [
      {
        ...
        type: 'text',
        localized: true,
        defaultValue: 'Alle verfügbaren Termine',
        label: 'Heading',
      ...
      },
      {
        ...
        type: 'text',
        localized: true,
        defaultValue: 'Für diese Workshop-Art gibt es derzeit keine verfügbaren Termine.',
