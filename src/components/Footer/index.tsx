...
export async function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-[#111111] text-[#1d1d1d] dark:text-white" style={footerStyle}>
      {/* Thin top border */}
      <div className="w-full h-px bg-[#1d1d1d]/10 dark:bg-white/10" />
      ...
      <div className="mx-auto max-w-344 px-6 md:px-10 lg:px-16 pt-10 pb-8 md:pt-12 md:pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10 lg:gap-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 lg:gap-10">
            {/* Quick Links */}
            <div>
              <h3 className="font-display font-bold text-sm uppercase tracking-widest mb-3 text-[#1d1d1d] dark:text-white">
                {quickLinksHeading}
              </h3>
      ...
      {/* ── Bottom bar ── */}
      <div className="border-t border-[#1d1d1d] dark:border-white/20">
        <div className="mx-auto max-w-344 px-6 md:px-10 lg:px-16 py-3 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="text-[#1d1d1d] dark:text-white/70 hover:text-(--footer-accent) transition-colors"
            >
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-end gap-x-4 gap-y-1 text-[11px] text-[#1d1d1d] dark:text-white/60">
            <span>
