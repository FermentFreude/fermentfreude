        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10 lg:gap-16">
          ...
          <div className="max-w-sm">
            ...
            <div className="mt-3 flex items-center gap-2">
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-[var(--footer-accent)]" />
              <span className="font-sans text-[10px] uppercase tracking-widest font-semibold bg-[var(--footer-accent)] px-1.5 py-0.5">
                {freeRecipesLabel}
              </span>
            </div>
          </div>
              ...
              <nav className="flex flex-col gap-1.5">
                {quickLinks.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="font-sans text-sm hover:text-[var(--footer-accent)] transition-colors"
                  >
                    {item.label}
                  </Link>
                ))}
        ...
        <div className="mx-auto max-w-344 px-6 md:px-10 lg:px-16 py-3 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="text-[#1d1d1d] hover:text-[var(--footer-accent)] transition-colors"
            >
