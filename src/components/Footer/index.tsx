...
export async function Footer() {
  ...
  return (
    <footer className="bg-white text-[#1d1d1d]">
      {/* Thin top border */}
              ...
              <nav className="flex flex-col gap-1.5">
                {QUICK_LINKS.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="font-sans text-sm hover:text-[#e6be68] transition-colors"
                  >
                    {item.label}
                  </Link>
                ))}
        ...
        <div className="mx-auto max-w-344 px-6 md:px-10 lg:px-16 py-3 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="text-[#1d1d1d] hover:text-[#e6be68] transition-colors"
            >
