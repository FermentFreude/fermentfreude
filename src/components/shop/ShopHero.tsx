...
type Props = {
  data?: ShopHeroData | null
}

export const ShopHero: React.FC<Props> = ({ data }) => {
  const { setHeaderTheme } = useHeaderTheme()
  useEffect(() => setHeaderTheme('dark'), [setHeaderTheme])

  const line1 = data?.heroTitleLine1 ?? DEFAULTS.heroTitleLine1
  const line2 = data?.heroTitleLine2 ?? DEFAULTS.heroTitleLine2
  ...
  return (
    <div className="relative flex flex-col justify-end min-h-[50vh] md:min-h-[60vh] text-white" data-theme="dark">
