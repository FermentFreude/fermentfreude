...
/**
 * Reusable Contact section with contact details + contact form.
 * Use on About page, Contact page, or any page that needs contact info.
 */
export function ContactSection({ contact, contactForm, className }: ContactSectionProps) {
  return (
    <section className={`w-full py-12 pb-16 md:py-24 ${className ?? ''}`}>
