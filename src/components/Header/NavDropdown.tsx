...
export function NavDropdown({ label, href, items }: NavDropdownProps) {
  ...
  const sharedClassName = cn(
    'relative navLink flex items-center gap-1 text-ff-gray-15 dark:text-neutral-300 font-semibold text-sm hover:text-ff-charcoal dark:hover:text-white transition-colors',
    { active: isActive },
  )
