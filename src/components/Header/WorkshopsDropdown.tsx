...
export function WorkshopsDropdown() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-56 rounded-xl border border-ff-white-95 bg-white shadow-lg overflow-hidden">
          <div className="py-2">
            {workshopItems.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  'block px-5 py-3 text-sm font-medium text-ff-gray-15 hover:bg-ff-ivory transition-colors',
