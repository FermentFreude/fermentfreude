    ...
    <div id={id} className={isEmbedded ? 'bg-ff-cream py-12 md:py-16' : 'min-h-screen bg-white'}>
      ...
      {!hideHeroSection && (
        ...
        >
          ...
          <div
            className={`relative z-10 mx-auto max-w-(--content-wide) ${
              hasHeroImage ? 'text-left' : 'text-center'
            }`}
          >
            <h1
              className={`text-hero font-bold ${hasHeroImage ? 'text-ff-cream' : 'text-ff-black'}`}
            >
              {hero.heading}
            </h1>
            {hero.subtext ? (
                      ...
                      <div className="mt-2 flex gap-3">
                        {social.facebook && (
                          <a
                            ...
                            aria-label="Facebook"
                            className="flex h-10 w-10 items-center justify-center rounded-full border border-ff-gold-accent/50 bg-white text-ff-charcoal shadow-sm transition-all duration-300 hover:scale-110 hover:border-ff-gold-accent hover:bg-ff-gold-accent hover:text-black hover:shadow-md"
                          >
      ...
      {!hideMap && mapEmbedUrl ? (
        <section className="w-full container-padding py-6 md:py-8">
          <div className="mx-auto max-w-(--content-wide) overflow-hidden border border-ff-border-light bg-white">
