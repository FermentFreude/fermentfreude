    ...
    >
      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="flex flex-col items-start gap-2 mb-(--space-content-xl) text-left">
          ...
          >
            {resolvedHeading.split(/(\b[A-ZÄÖÜ]{2,}\b)/g).map((part: string, i: number) =>
              /^[A-ZÄÖÜ]{2,}$/.test(part) ? (
        ...
        <div
          ref={cardRef}
          className="rounded-2xl overflow-hidden cursor-grab active:cursor-grabbing select-none relative"
          style={{ backgroundColor: CARD_BG, touchAction: 'pan-y pinch-zoom' }}
        >
          {/* Google Reviews Button — Top Right */}
          <a
            href="https://www.google.com/search?sca_esv=5176837d497f6a28&sxsrf=ANbL-n77vDWCZcVtmnSJwSmcLaUnRqZs0Q:1773442694546&q=Fermentfreude+Reviews&rflfq=1&num=20&stick=H4sIAAAAAAAAAONgkxIxNLM0NTYzMjYxNjMxNzAwMDYwNN_AyPiKUdQttSg3Na8krSi1NCVVISi1LDO1vHgRK3ZxAGJ6iO5LAAAA&rldimm=16953623436470003017&tbm=lcl&hl=en-DE&sa=X&ved=2ahUKEwiz4tnu_J2TAxW9VPEDHct2DlMQ9fQKegQITRAG&biw=1636&bih=1172&dpr=0.75#lkt=LocalPoiReviews"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="See reviews on Google"
            className="absolute top-6 right-6 z-10 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95"
            style={{
              backgroundColor: '#fff',
