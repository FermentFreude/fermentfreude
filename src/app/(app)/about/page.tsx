...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Top Banner */}
      <div className="flex items-center justify-center gap-6 bg-[#4B4B4B] px-6 py-4">
        <p className="text-center text-lg font-normal text-[#F9F0DC]">
          We Have Digital Workshops too, take a look
        </p>
        <svg
          width="26"
          height="26"
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M3.76367 12.5481C3.76367 12.0284 4.18498 11.6071 4.70468 11.6071L18.0519 11.6071L12.8352 6.6393C12.4606 6.27909 12.4489 5.68339 12.8091 5.30877C13.1694 4.93415 13.7651 4.92247 14.1397 5.28268L21.0404 11.8698C21.2249 12.0472 21.3292 12.2921 21.3292 12.5481C21.3292 12.804 21.2249 13.049 21.0404 13.2264L14.1397 19.8135C13.7651 20.1737 13.1694 20.162 12.8091 19.7874C12.4489 19.4128 12.4606 18.8171 12.8352 18.4568L18.0519 13.4891L4.70468 13.4891C4.18498 13.4891 3.76367 13.0678 3.76367 12.5481Z"
            fill="#F9F0DC"
          />
        </svg>
      </div>
      ...
      {/* Hero Banner */}
      <div className="relative h-[600px] w-full overflow-hidden bg-gradient-to-br from-[#F9F0DC] to-[#FAF2E0]">
        <div className="flex h-full items-center justify-center">
          <div className="text-center">
            <h1 className="font-display text-5xl font-bold text-[#1D1D1D]">
              FermentFreude Team
            </h1>
            <p className="mt-4 text-xl text-[#4B4B4B]">Bringing joy to fermentation</p>
          </div>
        </div>
      </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="flex flex-col items-center gap-12">
          {/* Section Label */}
          <div className="font-display text-5xl font-bold text-[#E5B765]">Our Story</div>
          ...
          <div className="flex max-w-6xl flex-col gap-8 bg-white py-12">
            <p className="text-center font-display text-2xl font-normal leading-relaxed text-[#1D1D1D]">
              FermentFreude is a modern Austrian food-tech startup helping people discover
              fermentation through fun workshops and premium fermented products. We combine health,
              enjoyment, and knowledge to make fermentation part of everyday life.
            </p>
            <p className="text-center font-display text-2xl font-normal leading-relaxed text-[#1D1D1D]">
              By merging traditional fermentation methods with modern science and regional sourcing,
              we empower home cooks and professionals to approach food with confidence, curiosity,
              and pleasure.
            </p>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="flex flex-col items-center gap-16">
          {/* Section Label */}
          <div className="font-display text-5xl font-bold text-[#E5B765]">Our Team</div>

          {/* Team Heading */}
          <h2 className="font-display text-center text-5xl font-bold text-[#1D1D1D]">
          ...
          <div className="grid w-full gap-12 md:grid-cols-2">
            ...
            <div className="flex flex-col items-center gap-8">
              <div className="flex h-[400px] w-full items-center justify-center overflow-hidden rounded-3xl bg-gradient-to-br from-[#E5B765] to-[#D4A860]">
                <div className="text-center">
                  <div className="font-display text-6xl font-bold text-white">MR</div>
                  <p className="mt-2 text-sm text-white/80">Photo coming soon</p>
                </div>
              </div>
              <div className="text-center">
                <h3 className="font-display mb-4 text-3xl font-bold text-[#1D1D1D]">
                  Marcel Rauminger
                </h3>
                <p className="font-display text-lg leading-relaxed text-[#1D1D1D]">
                  With over 17 years as a passionate chef and certificate in vegan cooking enriched
                  by months in a Thai monastery, Marcel discovered the keys to fermentation and has
                  become a specialist in creative fermented cuisine. His desire to expertise through
                  workshops, sharing new discoveries and passion for fine flavor.
                </p>
              </div>
            </div>
            ...
            {/* David Heider */}
            <div className="flex flex-col items-center gap-8">
              <div className="flex h-[400px] w-full items-center justify-center overflow-hidden rounded-3xl bg-gradient-to-br from-[#A89578] to-[#9D8B73]">
                <div className="text-center">
                  <div className="font-display text-6xl font-bold text-white">DH</div>
                  <p className="mt-2 text-sm text-white/80">Photo coming soon</p>
                </div>
              </div>
              <div className="text-center">
                ...
                <p className="font-display text-lg leading-relaxed text-[#1D1D1D]">
                  With a background in food science and economics, David is passionate about making
                  complex scientific concepts digestible for everyone. He develops open-sourced
                  fermentation techniques based fermented foods that taste amazing and support
                  wellbeing, creating the perfect bridge between science and art of
                  FermentFreude.
                </p>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="flex flex-col items-center gap-12">
          <h2 className="font-display text-center text-4xl font-bold text-[#1D1D1D]">
            This project is supported by:
          </h2>
          <div className="flex flex-wrap items-center justify-center gap-16">
            {/* Placeholder for sponsor logos */}
            <div className="flex h-24 w-48 items-center justify-center rounded-lg bg-gray-100">
              <span className="text-sm text-gray-500">Sponsor Logo 1</span>
            </div>
            <div className="flex h-24 w-48 items-center justify-center rounded-lg bg-gray-100">
              <span className="text-sm text-gray-500">Sponsor Logo 2</span>
            </div>
            <div className="flex h-24 w-48 items-center justify-center rounded-lg bg-gray-100">
              <span className="text-sm text-gray-500">Science Park Graz</span>
            </div>
            <div className="flex h-24 w-48 items-center justify-center rounded-lg bg-gray-100">
              <span className="text-sm text-gray-500">Sponsor Logo 4</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Contact Section */}
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="relative overflow-hidden rounded-[5rem] bg-white shadow-lg">
          <div className="grid gap-8 md:grid-cols-2">
            {/* Contact Details */}
            <div className="rounded-l-[5rem] bg-[#FAF2E0] p-16">
              <div className="flex flex-col gap-12">
                <h2 className="font-display text-5xl font-bold text-[#1E1E1E]">Contact Detail</h2>

                <p className="font-display text-2xl font-bold leading-relaxed text-[#555]">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <div className="font-display text-base font-bold text-[#555]">
                      Grabenstraße 15
                      <br />
                      8010 Graz
                    </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <div className="font-display mb-2 text-lg font-bold text-[#1E1E1E]">Phone</div>
                    <div className="font-display text-base font-bold text-[#555]">
                      +436604943577
                    </div>
                  </div>
            ...
            <div className="flex flex-col gap-6 p-16">
              <h2 className="font-display mb-4 text-4xl font-semibold text-black">
                Ask About Anything
              </h2>
      ...
      {/* Ready to Learn CTA */}
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="rounded-[2.75rem] bg-[#F9F0DC] px-24 py-20">
          <div className="flex flex-col items-center gap-12">
            <h2 className="font-display text-center text-6xl font-bold text-[#1D1D1D]">
              Ready to learn?
            </h2>

            <p className="max-w-4xl text-center font-display text-3xl font-semibold text-[#4B4B4B]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8">
              <Link
                href="/workshops"
                className="rounded-full bg-[#6B6B6B] px-20 py-6 font-display text-2xl font-semibold text-[#F9F0DC] transition-colors hover:bg-[#595959]"
              >
                View workshops
              </Link>
              <Link
                href="/courses"
                className="rounded-full border-4 border-[#4B4B4B] bg-white px-16 py-5 font-display text-2xl font-semibold text-[#4B4B4B] transition-colors hover:bg-[#F9F0DC]"
              >
