    ...
    <div className="space-y-8">
      ...
      <div className="bg-linear-to-r from-[#f9f0dc] to-[#fffef9] rounded-lg border border-[#e6be68] p-6 md:p-8">
        ...
        <p className="text-[#4b4f4a] text-sm md:text-base">
          From your dashboard you can view your recent orders, manage your addresses, and edit your
          account details.
        </p>
      ...
      {stats.recent.length > 0 && (
        <Card className="p-6 border-0 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              href="/account/orders"
              className="text-[#e6be68] hover:text-[#d4a85a] text-sm font-medium"
            >
              View All
            </Link>
          </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {stats.recent.map((order: any) => (
                  <tr
                    key={order.id}
                    className="border-b border-[#f0ede6] hover:bg-[#fffef9] transition-colors"
                  >
                    <td className="py-4 px-4 font-medium text-[#4b4b4b]">
