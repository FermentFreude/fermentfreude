...
export function DangerAccordion({
  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      ...
      >
        <div
          className="pointer-events-none absolute -right-8 -top-8 size-32 rounded-full bg-[#555954]/10 blur-2xl"
          aria-hidden
        />
        ...
        <AccordionContent className="px-6 pb-6 pt-4 md:px-8 md:pb-8">
          {intro && (
            <p className="text-body leading-relaxed text-ff-black sm:text-body-lg">{intro}</p>
          )}
