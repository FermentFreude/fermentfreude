...
export const BREVO_TEMPLATES = {
  ...
  PASSWORD_RESET: 10,
  LOGIN_NOTIFICATION: 11,

  // Workshop (5)
  WORKSHOP_BOOKING_CONFIRMATION: 12,
  WORKSHOP_7DAY_REMINDER: 13,
  WORKSHOP_1DAY_REMINDER: 14,
  POST_WORKSHOP_FOLLOWUP: 15,
  FEEDBACK_REQUEST: 16,

  // E-commerce (4)
  ORDER_CONFIRMATION: 17,
  SHIPPING_NOTIFICATION: 18,
  REVIEW_REQUEST: 19,
  ABANDONED_CART: 20,

  // Marketing (5)
  NEWSLETTER_WELCOME: 21,
  COURSE_ENROLLMENT: 22,
  B2B_INQUIRY: 23,
  RE_ENGAGEMENT: 24,
  REFERRAL_PROGRAM: 25,

  // Custom
  VOUCHER_PURCHASED: 26,
} as const
